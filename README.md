...
*   **Git:**
*   **Node.js** (версия 18 или выше) и **npm/yarn/pnpm:**
*   **Foundry** - фреймворк для разработки смарт-контрактов
...
#### **2.5 При создании стратегии необходимо реализовать следующий функционал:**
...
Необходимо учитывать особенности конченого контракта, будь то прямой перевод (transfer) или только разрешение на перевод (approve)
```solidity
...
##### **2.6 Скомпилируйте и протестируйте ваши контракт смарт-контракты:**
