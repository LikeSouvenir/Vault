...
- [1 - Описание](#1-документация-по-развертыванию-запуску-и-функционалу)
...
#### **2.5 Скомпилируйте и протестируйте ваши смарт-контракты:**
...
```
**`--checklist > slitherResult.md`** - выведет ин    фрмацию в файл
